...
import model.text.extract_company_industry_trend as extract_industry_trend
...
def extract_method(detail, induhc2, sec_name, title):
    ...
    knowledge = extract_industry_trend.extract_company_industry_trend(text_list, text_page_list)
    text_knowledges = []
    table_knowledges = []
